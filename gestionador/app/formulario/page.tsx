      ...
      <div className="flex flex-col md:flex-row bg-[#121212] rounded-3xl shadow-xl overflow-hidden max-w-6xl w-full">
        ...
        <div className="md:w-1/2 p-10 flex flex-col justify-center space-y-6 bg-[#1a1a1a]">
          ...
          <p className="text-gray-300 text-lg">
            Cuando agendes tu demo, un agente de Inventra se pondrá en contacto contigo
            para dar seguimiento al tema de interés.
          </p>
        </div>
        ...
        >
          ...
          <div className="flex flex-col">
            <input
              ...
              className="w-full p-3 rounded-lg bg-[#2a2a2a] text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-[#ffffff88]"
            />
          ...
          <button
            type="submit"
            className="w-full py-3 mt-2 rounded-lg bg-gradient-to-r from-white to-gray-300 text-black font-semibold hover:from-gray-200 hover:to-gray-400 transition-all"
          >
            Enviar
          </button>
        </form>
