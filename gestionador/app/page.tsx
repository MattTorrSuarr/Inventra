  ...
  <div className="flex gap-[20px] text-white">
    ...
    <Link href="/formulario">
     ...
     <div className="text-white text-left font-semibold text-[80px] mt-[100px] mr-250 ml-auto max-w-[800px]">
      <p className="flex items-center justify-center text-[15px] h-[30px] w-[200px] font-normal rounded-full bg-[#1a1a1a] text-[#8b8b8b]">Soporte 24/7</p>
     <h5>Un software para la gestión de inventario de productos</h5>
     <p className="text-[20px] font-light  mt-[20px] text-[#8b8b8b] ">Inventra es una herramienta de software diseñada para empresas que buscan tener un mayor control de su inventario y productos de forma eficiente y automatizada.
...
<Link href={"/formulario"}><button className="mt-[75px] w-[250px] h-[100px] bg-[#1f1f1f] rounded-[10px] font-medium border border-[#3d3d3d] mx-auto flex items-center justify-center">Agendar demo</button></Link>
     ...
     <div className="text-left text-white ">
      <h1 className="text-center mt-[80px] text-[50px] font-medium  text-left ml-[500px] mr-auto  max-w-[500px]">¿Como funciona?</h1>
      <p className="mt-[10px] text-[#8b8b8b] text-[20px] text-left ml-[500px] mr-auto max-w-[500px]">Somos una empresa de tecnología mexicana especializada en el desarrollo de sistemas inteligentes para la gestión de inventarios.
Nuestro software te ayuda a organizar, controlar y optimizar tus productos de forma automatizada, facilitando la toma de decisiones y mejorando la eficiencia de tu negocio.  </p>
      <div className="flex items-center ml-[500px] mt-[10px] space-x-4">
  <Link href="/formulario">
    <button className="mt-[10px] text-[#8b8b8b] w-[250px] h-[100px] bg-[#1f1f1f] rounded-[10px] font-medium border border-[#3d3d3d] flex items-center justify-center">
      Agendar demo
    </button>
  </Link>

  <Link href="/formulario">
    <button className="text-[#ffffff] w-[250px] h-[100px] rounded-[10px] font-medium flex items-center justify-center">
      <span className="mt-[10px] flex items-center gap-2 hover:bg-[#131313] transition  w-[250px] h-[100px] justify-center rounded-[10px]">
        Conoce más
        <ChevronRight height={20} width={20} className="text-white" />
      </span>
    </button>
